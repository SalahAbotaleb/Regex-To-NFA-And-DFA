...
def or_graphs(graph1: Graph, graph2: Graph) -> Graph:
    ...
    final_graph.start.add_edge(
        graph1.get_start(), constants.GraphTerm.EPSILON_ACTION)
    graph1.get_start().set_is_start(False)
    final_graph.start.add_edge(
        graph2.get_start(), constants.GraphTerm.EPSILON_ACTION)
...
def one_or_more(graph: Graph) -> Graph:
    ...
    terminal.add_edge(final_graph.get_start(),
                      constants.GraphTerm.EPSILON_ACTION)
    terminal.set_is_terminal(False)
